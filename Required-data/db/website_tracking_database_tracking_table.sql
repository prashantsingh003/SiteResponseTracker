...
CREATE TABLE `tracking_table` (
  ...
  KEY `idx_tracking_table_status` (`status_code`),
  KEY `idx_tracking_table_response_time` (`response_time`),
  KEY `idx_tracking_table_datetime` (`date_time`),
  KEY `websiteid_idx` (`websiteid`),
  CONSTRAINT `FK_website_id` FOREIGN KEY (`websiteid`) REFERENCES `website_table` (`website_id`) ON DELETE CASCADE
